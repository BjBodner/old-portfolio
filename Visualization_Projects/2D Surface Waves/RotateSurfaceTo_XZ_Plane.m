function [M,EndingFrame] = RotateSurfaceTo_XZ_Plane(X,Y,Z,FramesOfRotation,HighlightAxis,FramesOfAltitudeChange,EndingFrame,M)
...
for i = 1:FramesOfRotation
    % Example of plot
    surf(X,Y,Z)
    az = 322.5 + 37.5*i/FramesOfRotation;
    el = 30;
    view(az, el);
