function [ParameterVector,CurrentCost,TotalTime] = Pinball_Optimizer_Without_Cooling(ParameterVector,Search_Ratio,NumberOfItterations,NumberOfSamples__In_Each_Itteration,AmplitudeOfLinearSearch,AmplitudeOfRandomSearch,Readout)
