...
for initialization = 1:Number_Of_Initialization_Tests
    ...
    for itteration = 1:Number_Of_Ittertions
        ...
        if RecomendedResourceAllocation(1) > 0 % Part 1 of Guessing_Game_Optimizer
            ...
            %[Suggested_Parameter_Samples_From_Guessing_Game,LengthOfVectors,RandomVectors] = Guessing_Game_Optimizer_Version2_Part1(Initial_Parameters,NumberRandomVectors,dt);
        end
