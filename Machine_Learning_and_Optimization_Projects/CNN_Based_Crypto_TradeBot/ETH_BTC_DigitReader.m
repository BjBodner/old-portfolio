function [ETH_BTC_Multiplied_by_10_5] = ETH_BTC_DigitReader(BNB_ETH)
...
ETH_BTC_Multiplied_by_10_5 = (ChosenDigit(1)*10^-1 + ChosenDigit(2)*10^-2 + ChosenDigit(3)*10^-3 + ChosenDigit(4)*10^-4 + ChosenDigit(5)*10^-5+ChosenDigit(6)*10^-6)*10^7;